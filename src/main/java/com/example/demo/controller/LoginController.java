...
public class LoginController implements CommunityConstant {
    ...
    public String register(Model model, User user){
        ...
        if(map == null || map.isEmpty()){
            model.addAttribute("msg", "注册成功，已向您的邮箱发送了激活邮件");
    ...
    public String login(String username, String password, String code, boolean remember, Model model, /*HttpSession httpSession, */
        ...
        //检查账号密码
        int expiredSecond = remember ? REMEMBER_EXPIRED_SECOND : DEFAULT_EXPIRED_SECOND;
